...
foreach gis:feature-list-of countries [ [vector-feature] ->
  ...
  ask country-labels with [ country-name-label = "Belize"]
      [set xcor xcor ;+ 4 DSR: I commented out the +4 so that the label is not printed in the ocean
       set ycor ycor - 1.5]
end
...
foreach gis:feature-list-of mex_districts [ [vector-feature] ->
      ...
      [ create-district-labels 1
        [ set xcor item 0 centroid
          ...
          ; DSR I added the next two lines so that labels are printed
          set label-color black
          set label district-name-label
          set pop-2015 gis:property-value vector-feature "POP_2015"
      ]]]
  ...
  if pop-display = "all" ; all countries
     [ask country-labels
      ...
      ask people
        ...
        ; DSR: I commented out the next line as it kills all the people outside Mexico
